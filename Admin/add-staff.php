<?php include('./partials/header.php'); ?>
                        ...
                        <form class="form-horizontal" action="" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group row">
                                <div class="col-sm-10 ml-sm-auto">
                                     <input class="btn btn-info" type="submit" name="submit" value="Add Staff"></input>
                                </div>
                            </div>
                        </form>
                    </div>
 ...
 <?php 
            if(isset($_POST['submit'])){
                ...
                if($res==true){
                    // tạo sesion lưu thông báo 
                    $_SESSION['add'] = "<p class='text-success'>Staff Add Successfully</p>";
                    // chuyến hướng đến trang manage
                    echo("<script>location.href = '".SITEURL."admin/manage-staff.php';</script>");
                }else{
                    // tạo sesion lưu thông báo 
                    $_SESSION['add'] = "<p class='text-success'>Fail To Add Staff</p>";
                    // chuyến hướng đến trang manage
                    echo("<script>location.href = '".SITEURL."admin/manage-staff.php';</script>");
                }
            }
